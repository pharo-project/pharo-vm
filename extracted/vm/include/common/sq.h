...
int storeIntegerofObjectwithValue(sqInt fieldIndex, sqInt objectPointer, sqInt integerValue);
...
#if SPURVM
void *ioLoadExternalFunctionOfLengthFromModuleOfLengthAccessorDepthInto(sqInt functionNameIndex, sqInt functionNameLength,
...
EXPORT(int)
ioGetCurrentWorkingDirectorymaxLength(char *aCString, size_t maxLength);
