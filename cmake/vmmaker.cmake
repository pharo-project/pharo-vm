...
if(GENERATE_SOURCES)
    ...
    add_custom_command(
        ...
        COMMAND ${VMMAKER_VM} --headless ${VMMAKER_IMAGE} --no-default-preferences eval \"PharoVMMaker generate: \#\'${FLAVOUR}\' outputDirectory: \'${GENERATED_SOURCE_DIR}\' imageFormat: \'${IMAGE_FORMAT}\'\"
